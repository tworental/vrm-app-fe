      ...
      `<form class="warning-modal">
          <div class="uk-modal-body">
            <div class="warning-modal__heading">
                ...
                <div class="warning-modal__title">${i18n.global.t('core.shared.warningModal.title')}</div>
            </div>
          </div>
          <div class="uk-modal-footer warning-modal__footer">
              <div class="warning-modal__text">
                ${isString(message) ? message : html(message)}
              </div>
              <div class="uk-text-right">
                <button class="uk-button warning-modal__submit">
                  <span>${i18n.global.t('core.shared.warningModal.ok')}</span>
                </button>
              </div>
          </div>
       </form>`
